...
public class PetFragment extends Fragment {
    ...
    private final String PET_URL = "https://api.unsplash.com/collections/139386/photos/?client_id=" + CLIENT_ID;
    ...
    private void getPetImageData() {





        // perform volley JsonArrayRequest to retrieve list of pet images urls
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, PET_URL, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i=0;i<response.length();i++)
                            {
                                ...
                                Log.d("petData", "onResponse: " +imgUrls + " , desc : " +imgDesc);
